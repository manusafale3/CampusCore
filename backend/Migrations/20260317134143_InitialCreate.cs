        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tuition = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    LabFee = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    LibraryFee = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    ActivityFee = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceLogs_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceLogs_CourseId",
